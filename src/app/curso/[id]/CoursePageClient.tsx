...
export const cursos: Record<string, Course> = {
  ...
  "teologia-sistematica": {
    ...
    descricaoCompleta:
      "A Teologia Sistemática oferece uma compreensão organizada e abrangente das principais doutrinas cristãs. Este curso explora sistematicamente a revelação de Deus nas Escrituras, organizando os ensinamentos bíblicos em categorias teológicas claras e aplicáveis à vida cristã.",
    duracao: "12 semanas",
    nivel: "Intermediário",
    ...
    status: "proximo",
    imagem: "/images/cursos/panorama-biblico.jpg",
    professor: "Rev. Roberto Alves",
    cargaHoraria: "36 horas",
    formato: "Presencial - Sextas-feiras às 19h30",
    objetivos: [
