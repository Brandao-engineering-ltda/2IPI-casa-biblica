    ...
    <section className="relative flex min-h-[calc(100vh-80px)] items-center justify-center overflow-hidden bg-navy-dark">
      ...
      <div className="relative mx-auto w-full max-w-md px-6 py-16">
        <div className="rounded-2xl border border-cream-dark/10 bg-navy p-8 shadow-xl">
          ...
          {resetSent && (
            <div className="mt-4 rounded-lg bg-green-500/10 px-4 py-3 text-center text-sm text-green-400">
              E-mail de redefinição enviado! Verifique sua caixa de entrada.
            </div>
          )}

          {resetMode ? (
            <form onSubmit={handlePasswordReset} className="mt-8 flex flex-col gap-5">
              <div>
                <label
                  htmlFor="reset-email"
              ...
              <button
                type="submit"
                disabled={loading}
                className="mt-2 w-full rounded-full bg-primary px-8 py-3.5 text-base font-semibold text-white transition-colors hover:bg-primary-dark disabled:opacity-50"
              >
            ...
            <>
              <form onSubmit={handleSubmit} className="mt-8 flex flex-col gap-5">
                ...
                <div>
                  <div className="mb-1.5 flex items-center justify-between">
                    <label
                      htmlFor="password"
                      className="text-sm font-medium text-cream-dark"
                    >
                      Senha
                    </label>
                    <button
              ...
              <div className="mt-6 flex flex-col items-center gap-4">
                ...
                <button
                  ...
                  disabled={loading}
                  className="flex w-full items-center justify-center gap-3 rounded-full border border-cream-dark/20 bg-white px-8 py-3.5 text-base font-semibold text-navy transition-colors hover:bg-cream disabled:opacity-50"
                >
                  {loading ? (
                    "Entrando..."
                  ) : (
